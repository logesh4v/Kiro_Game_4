...
exports.SafetyDisclaimer = void 0;
class SafetyDisclaimer {
    ...
    toggleDetails() {
        const detailsContent = this.disclaimerElement.querySelector('.disclaimer-details-content');
        const expandButton = this.disclaimerElement.querySelector('.expand-button');
    ...
    static createAndShow(container, config = {}) {
...
exports.SafetyDisclaimer = SafetyDisclaimer;
//# sourceMappingURL=SafetyDisclaimer.js.map